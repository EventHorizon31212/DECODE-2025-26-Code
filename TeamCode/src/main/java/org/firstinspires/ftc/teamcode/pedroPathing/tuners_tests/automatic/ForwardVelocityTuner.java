...
Constants.setConstants(FConstants.class, LConstants.class);
        ...
        frontLeft = hardwareMap.get(DcMotor.class, leftFrontMotorName);
        backLeft = hardwareMap.get(DcMotor.class, leftRearMotorName);
        backRight = hardwareMap.get(DcMotor.class, rightRearMotorName);
        frontRight = hardwareMap.get(DcMotor.class, rightFrontMotorName);
        frontLeft.setDirection(leftFrontMotorDirection);
        backLeft.setDirection(leftRearMotorDirection);
        frontRight.setDirection(rightFrontMotorDirection);
        backRight.setDirection(rightRearMotorDirection);
